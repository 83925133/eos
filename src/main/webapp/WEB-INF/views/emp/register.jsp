...
<form method=post action="<c:out value="${ctx}" />/static/userdat/regok/" name=form1 onSubmit="return chk(this)">
...
<table border="0" width="950" id="table38" background="<c:out value="${ctx}" />/static/img/4.jpg" height="45">
  <tr>
    <td align=left height="45" width="296">
	<p align="center">
<table border="0" width="100%" id="table38" background="<c:out value="${ctx}" />/static/img/4.jpg" height="45">
  <tr>
	...
	<a href="http://www.eos580.com"><font color="#FFFFFF">www.eos580.com</font></a>&nbsp;</font><font face="微软雅黑" size="2" color="#FFFFFF">
	</font></b></td>
  </tr>
    <tr>
    <td align=center valign="top"><i><font face="微软雅黑" color="#FFFFFF" size="2">e-order system</font></i></td>
  </tr>
</table>	
	
	</td>

    <td align=right height="45" width="149"></td>
    <td align=center height="45"><font face="微软雅黑" size="5" color="#FFFFFF" face="微软雅黑"><% if (request("utype")="sale" or request("utype")="buysale") then%><%=request("topic")%><% else %>580订货网，订货我帮您<% end if %></font></td>
  </tr>
</table>
...
<input type=hidden name="urlstr" value="<%=request("urlstr")%>">
