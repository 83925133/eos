...
<table border="0" width="950" id="table38">
  <tr>
	...
	<td align=left height="35" style="font-family: 微软雅黑; font-size: 10pt"><b>当前位置:&nbsp;</b>&nbsp;处理单据 &gt;&nbsp; 待处理单据&nbsp; </td>
...
<table width="950" id="table20" style="border:1px solid #E9F1F4; font-family: 微软雅黑; font-size: 10pt; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px"cellpadding="0" cellspacing="0" bordercolor="#C4D5E0">
    ...
    <input style="text-align:righ;border:1px dotted #ADC0C9;background-color:#FFFFFF; padding-left:3px; padding-right:1px; padding-top:1px; padding-bottom:1px; font-family:微软雅黑; font-size:10pt" type="text" name="qbno" size="20" value="${qbno}"></td>
...
<c:forEach items="${billInfos.datas}" var="billInfo" varStatus="i">
...
<c:if test="${fn:length(billInfos.datas) ne 0}">
			...
			<tbody>
				<tr>
					<td style="vertical-align: top;">
						<jsp:include page="/WEB-INF/pager/pager.jsp">
							<jsp:param name="totalRecord" value="${billInfos.total}"/>
							<jsp:param name="url" value="${ctx}/bill/findUncheckedBill"/>
						</jsp:include>
					</td>
				</tr>
			</tbody>
...
<c:if test="${fn:length(billInfos.datas) eq 0}">
curPage ===${curPage}
...
function dosubmit(myvar){  
  ...
  if(myvar=="query") {
    ...
    form1.action="<c:out value="${ctx}" />/bill/findUncheckedBill";    
    form1.submit();
  }
